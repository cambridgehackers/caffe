...
if(NOT APPLE)
  ...
  if(BLAS STREQUAL "Atlas" OR BLAS STREQUAL "atlas")
    ...
    #find_library(Caffe_LINKER_LIBS NAMES libatlas.a)
    include_directories(SYSTEM ${Atlas_INCLUDE_DIR})
    list(APPEND Caffe_LINKER_LIBS /usr/lib/libopenblas.a /usr/lib/x86_64-linux-gnu/libpthread.so ${Atlas_LIBRARIES})
    list(APPEND Caffe_LINKER_LIBS /usr/lib/x86_64-linux-gnu/libpapi.so)
